...
const impactStats = [
 {
  ...
  { value: 4200, suffix: '', label: 'Households Reached', sublabel: '4,200 selected households', note:'<span style="display:block; text-align:justify; line-height:1.6;"> RUSTIC supports approximately 4,580 underprivileged people through 243 female and male groups. These groups support skill development, income-generating activities, savings management, leadership, and community participation.', color: '#55C7DD', decimals: 0 },
  { value: 3.5, suffix: ' MT', label: 'Solid Waste Collected', sublabel: '3.0–3.5 MT daily', note: '<span style="display:block; text-align:justify; line-height:1.6;">RUSTIC collects and manages 3.0–3.5 MT of solid waste daily from selected households, supporting cleaner and healthier communities.', color: '#159FC1', decimals: 1 },
  { value: 1.8, suffix: ' MT', label: 'Organic Fertilizer Produced', sublabel: '1.6–1.8 MT daily', note: '<span style="display:block; text-align:justify; line-height:1.6;">Through its waste-management and composting activities, RUSTIC produces 1.6–1.8 MT of organic fertilizer daily, turning organic waste into a valuable resource.</span>', color: '#D88A60', decimals: 1 },
  {
  value: 2800,
  suffix: '+',
...
const storySteps = [
  {
    ...
    description: 'RUSTIC works with poor and vulnerable communities facing poverty, limited opportunities, natural disasters, salinity, waterlogging, and loss of livelihoods. Its programmes focus on improving living standards, access to resources, skills, income, employment, and basic rights.'
  },

  {
    ...
    description: 'RUSTIC believes sustainable change begins when people have the knowledge, skills, resources, and collective strength to shape their own future. Through community groups, education, skills development, savings, entrepreneurship, and awareness, people are supported to become more self-reliant.'
  },

  {
    ...
    description: 'RUSTIC promotes sustainable livelihoods and environmentally responsible solutions. From sustainable agriculture and micro-entrepreneurship to waste management, composting, improved cookstoves, biogas, and biodiversity conservation, its programmes connect economic development with environmental protection.'
  },
...

  {
    ...
    description: 'At the heart of RUSTIC\'s work is the belief that lasting development is built with communities. By organizing grassroots people, strengthening local institutions, supporting women and children, protecting rights, and building partnerships, RUSTIC works toward communities where people can live with dignity while protecting the environment around them.'
  }
];

const pillars = [
  { number: '01', title: 'Organization Building & Institutionalization', description: 'Strengthening grassroots institutions, governance, and community-led organizations to create lasting systemic change.', color: '#123D2A', accent: '#16A765', icon: 'building' },
  { number: '02', title: 'Education & Human Resource Development', description: 'Investing in education, skills training, and human development to unlock potential and break cycles of poverty.', color: '#008F9C', accent: '#55C7DD', icon: 'graduation' },
  { number: '03', title: 'Food Security & Economic Self-Reliance', description: 'Creating sustainable livelihoods, improving food security, and enabling economic independence for vulnerable families.', color: '#247A45', accent: '#3DBC7E', icon: 'wheat' },
  { number: '04', title: 'Climate Resilience & Environmental Protection', description: 'Protecting ecosystems, building climate resilience, and transforming waste into resources for a sustainable future.', color: '#005A63', accent: '#008F9C', icon: 'leaf' },
  { number: '05', title: 'Rights Protection & Healthcare', description: 'Defending human rights, expanding healthcare access, and ensuring dignity and well-being for every community member.', color: '#A84C24', accent: '#D88A60', icon: 'heart' },
];

const wasteProcess = [
  { step: '01', title: 'Household Waste', description: 'RUSTIC’s waste management initiative engages 4,200 selected households across its working areas, bringing households into a community-based approach to managing everyday waste. The initiative encourages communities to take greater responsibility for their local environment while making household waste the starting point for resource recovery and processing. Through this community participation, the programme creates the foundation for cleaner surroundings and more sustainable waste management practices.', color: '#8A3A1B', icon: 'home' },
  { step: '02', title: 'Collection', description: 'Waste is collected from the selected households through an organized community-based system, with approximately 3.0–3.5 metric tons of solid waste collected daily. This regular collection helps prevent household waste from accumulating within the community and brings the waste together for further management and resource recovery. In this way, the collection process contributes to cleaner surroundings and improved environmental practices.', color: '#A84C24', icon: 'trash' },
  { step: '03', title: 'Sorting', description: 'Collected waste is sorted at the community level into organic, recyclable, and reject categories. This separation helps identify materials that can be recovered, recycled, composted, or processed appropriately. Organic waste can then be directed towards composting and vermicomposting, while recyclable materials can be recovered for further use. Proper sorting makes the waste management process more organized and efficient. It also helps maximize resource recovery while reducing the amount of waste that ultimately requires disposal.', color: '#C26A3E', icon: 'filter' },
  { step: '04', title: 'Composting', description: 'Organic waste is processed through composting and vermicomposting activities, where biodegradable materials are transformed into valuable organic material. These processes use natural biological methods to break down organic waste and produce material that can be used as an organic input for agricultural activities. By converting biodegradable waste into useful resources, the process helps reduce waste while returning valuable nutrients to the soil.', color: '#247A45', icon: 'recycle' },
  { step: '05', title: 'Organic Fertilizer', description: 'RUSTIC’s waste-processing activities produce approximately 1.6–1.8 metric tons of organic fertilizer daily, transforming organic waste from a disposal challenge into a valuable resource. The resulting fertilizer provides an environmentally responsible agricultural input and demonstrates how waste can be recovered and given a second purpose. This creates a direct connection between responsible waste management, resource recovery, and agricultural use.', color: '#16A765', icon: 'sprout' },
  { step: '06', title: 'Sustainable Agriculture', description: 'The organic fertilizer produced through RUSTIC’s waste management activities can support agricultural activities, creating a practical connection between responsible waste management and farming. By returning organic resources to the land instead of treating them only as waste, the approach supports RUSTIC’s broader focus on sustainable agriculture and environmental protection. Together, these activities demonstrate a waste-to-resource cycle that connects communities, waste management, resource recovery, and sustainable agriculture.', color: '#123D2A', icon: 'wheat' },
];

const environmentInitiatives = [
  { title: 'Solid Waste Management', description: 'Community-led collection and processing of 3.0–3.5 MT of solid waste daily, transforming urban waste into valuable resources.', icon: 'trash', color: '#16A765' },
  { title: 'Vermicompost & Vermiculture', description: 'Producing 1.6–1.8 MT of organic fertilizer daily using earthworm-based composting systems.', icon: 'bug', color: '#247A45' },
  { title: 'Biodiversity Conservation', description: 'Protecting local ecosystems and species through community-driven conservation programs in the Sundarbans region.', icon: 'bird', color: '#008F9C' },
  { title: 'Improved Cook Stoves', description: 'Distributing fuel-efficient stoves that reduce firewood consumption and indoor air pollution for rural families.', icon: 'flame', color: '#159FC1' },
  { title: 'Biogas', description: 'Converting organic waste into clean energy, reducing dependence on fossil fuels and improving household health.', icon: 'zap', color: '#55C7DD' },
  { title: 'Water & Sanitation', description: 'Ensuring access to safe drinking water and sanitation facilities for vulnerable communities.', icon: 'droplets', color: '#2DB8C4' },
  { title: 'Forestry / Afforestation', description: '16,500 tree saplings planted and 16.5 km of roadside plantation across working areas.', icon: 'tree', color: '#3DBC7E' },
  { title: 'Sustainable Agriculture', description: 'Promoting climate-resilient farming practices that protect soil health and ensure food security.', icon: 'wheat', color: '#16A765' },
];

const forestryStats = [
  { value: 16500, suffix: '', label: 'Tree Saplings Planted', note: 'Reported in organizational profile', decimals: 0 },
  { value: 16.5, suffix: ' KM', label: 'Roadside Plantation', note: 'Reported in organizational profile', decimals: 1 },
  { value: 60, suffix: '%', label: 'Survival Rate', note: 'Approximately, as reported in profile', decimals: 0 },
];

const communityAreas = [
  { title: 'Education', description: 'Schools, learning centers, and scholarship programs opening doors for the next generation.', icon: 'book', color: '#16A765' },
  { title: "Women's Empowerment", description: 'Skills training, entrepreneurship support, and leadership development for women.', icon: 'sparkles', color: '#A84C24' },
  { title: 'Healthcare', description: 'Community health services, awareness campaigns, and access to essential care.', icon: 'heart', color: '#008F9C' },
  { title: 'Safe Drinking Water', description: 'Ensuring clean water access through infrastructure and water quality monitoring.', icon: 'droplets', color: '#159FC1' },
  { title: 'Child Rights', description: 'Protecting children from exploitation and ensuring access to education and care.', icon: 'shield', color: '#247A45' },
  { title: 'Economic Self-Reliance', description: 'Livelihood training, micro-enterprise, and financial inclusion for families.', icon: 'trending', color: '#D88A60' },
  { title: 'Community Development', description: 'Building infrastructure, governance, and collective capacity for lasting change.', icon: 'users', color: '#16A765' },
];

const locations = [
  { name: 'Khulna', description: 'Primary working area and organizational base. Home to RUSTIC headquarters and core program operations across urban and rural communities.', x: 35, y: 62, color: '#16A765' },
  { name: 'Bagerhat', description: 'Coastal district where RUSTIC implements climate resilience, waste management, and sustainable agriculture programs.', x: 42, y: 72, color: '#008F9C' },
  { name: 'Satkhira', description: 'Climate-vulnerable district near the Sundarbans, focus of environmental protection and biodiversity conservation efforts.', x: 22, y: 68, color: '#159FC1' },
];

const partners = [
  'Department of Environment', 'Local Government Division', 'Ministry of Forests',
  'Khulna City Corporation', 'Bangladesh NGO Foundation', 'CARITAS Bangladesh',
  'CARE Bangladesh', 'GIZ & UNDP', 'Seven Hills Global Outreach', 'Bangladesh NGO Foundation',
];

const footerPrograms = ['Waste Management', 'Climate Resilience', 'Education', 'Healthcare', 'Afforestation', 'Women Empowerment'];

// ---------- Section photos ----------
const sectionPhotos = {
  impact: 'images/logo-header.png',
  story: 'https://images.pexels.com/photos/35697505/pexels-photo-35697505.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  waste: 'https://images.pexels.com/photos/5354625/pexels-photo-5354625.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  environment: 'https://images.pexels.com/photos/34850157/pexels-photo-34850157.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  forestry: 'https://images.pexels.com/photos/28662987/pexels-photo-28662987.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  community: 'https://images.pexels.com/photos/36384099/pexels-photo-36384099.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  education: 'https://images.pexels.com/photos/36666949/pexels-photo-36666949.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  locations: 'https://images.pexels.com/photos/33337866/pexels-photo-33337866.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
  leadership: 'https://images.pexels.com/photos/36746079/pexels-photo-36746079.jpeg?auto=compress&cs=tinysrgb&h=650&w=940',
};

// ---------- Gallery photos ----------
const galleryPhotos = [
  { src: 'https://images.pexels.com/photos/16039757/pexels-photo-16039757.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Community Care', category: 'community', description: 'A mother tends to her baby in Gazipur, representing the families RUSTIC supports.' },
  { src: 'https://images.pexels.com/photos/36384099/pexels-photo-36384099.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Women Gathering', category: 'community', description: 'Village women in Bangladesh gather for community development planning.' },
  { src: 'https://images.pexels.com/photos/5354625/pexels-photo-5354625.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Recycling Plastics', category: 'waste', description: 'Two women sorting plastic bottles for recycling in Chattogram.' },
  { src: 'https://images.pexels.com/photos/31416070/pexels-photo-31416070.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Composting at Home', category: 'waste', description: 'Community members composting organic waste to produce fertilizer.' },
  { src: 'https://images.pexels.com/photos/28662987/pexels-photo-28662987.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Tree Planting', category: 'forestry', description: 'A community member planting a sapling as part of RUSTIC\'s afforestation program.' },
  { src: 'https://images.pexels.com/photos/29290592/pexels-photo-29290592.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Sundarbans Mangrove', category: 'forestry', description: 'Lush mangrove forest in the Sundarbans, a key conservation area.' },
  { src: 'https://images.pexels.com/photos/36666949/pexels-photo-36666949.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Outdoor Classroom', category: 'education', description: 'A teacher sits with students in an outdoor classroom in Rangpur.' },
  { src: 'https://images.pexels.com/photos/36830379/pexels-photo-36830379.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Rural Classroom', category: 'education', description: 'Children studying in a vibrant rural classroom in Bangladesh.' },
  { src: 'https://images.pexels.com/photos/34850157/pexels-photo-34850157.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Flooded Fields', category: 'climate', description: 'Aerial view of flooded fields in Bangladesh under dramatic storm clouds.' },
  { src: 'https://images.pexels.com/photos/39164204/pexels-photo-39164204.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Flooded Village', category: 'climate', description: 'A village submerged in floodwaters, highlighting climate vulnerability.' },
  { src: 'https://images.pexels.com/photos/20008982/pexels-photo-20008982.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Clean Water Access', category: 'community', description: 'A child drinks from a hand pump, representing improved water access.' },
  { src: 'https://images.pexels.com/photos/8248293/pexels-photo-8248293.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Healthcare Checkup', category: 'community', description: 'A healthcare worker measures blood pressure during a community visit.' },
  { src: 'https://images.pexels.com/photos/38534084/pexels-photo-38534084.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Sustainable Farming', category: 'forestry', description: 'Vibrant green vegetable field showcasing sustainable agriculture practices.' },
  { src: 'https://images.pexels.com/photos/33337866/pexels-photo-33337866.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Sundarbans Waterways', category: 'climate', description: 'Lush mangrove waterways in the Sundarbans, Khulna.' },
  { src: 'https://images.pexels.com/photos/37560294/pexels-photo-37560294.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Improved Cook Stoves', category: 'waste', description: 'A woman uses a clay stove, representing RUSTIC\'s improved cook stove program.' },
  { src: 'images.pexels.com/photos/13888402/pexels-photo-13888402.jpeg?auto=compress&cs=tinysrgb&h=650&w=940', title: 'Rice Cultivation', category: 'forestry', description: 'Lush rows of green rice plants in a vibrant field.' },
];
...
// ---------- SVG Icon Paths ----------
const icons = {
  building: '<path d="M6 22V4a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v18Z"/><path d="M6 12h12"/><path d="M6 16h12"/><path d="M6 8h12"/>',
  ...
  sprout: '<path d="M7 20h10M10 20c5.5-2.5.8-6.4 3-10M8.5 8.5c.8-1.5 2-2 3.5-2 1.5 0 2.7.5 3.5 2M9 12c.8-1.5 2-2 3.5-2 1.5 0 2.7.5 3.5 2"/>',
  ...
  flame: '<path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.143-.224-4.054 2-6 .5 2.5 2 4.9 4 6.5 2 1.6 3 3.5 3 5.5a7 7 0 1 1-14 0c0-1.153.433-2.244 1-3a2.5 2.5 0 0 0 2.5 2.5Z"/>',
  zap: '<polygon points="13 2 3 14 12 14 11 22 21 10 12 10 13 2"/>',
  droplets: '<path d="M7 16.3c2.2 0 4-1.83 4-4.05 0-1.16-.57-2.26-1.71-3.19S7.29 6.75 6 6.5c.34.67.5 1.35.5 2.04 0 .7-.17 1.3-.5 2 .34.67.5 1.35.5 2.04 0 .7-.17 1.3-.5 2"/><path d="M12.56 6.6c1.8 1.7 2.7 3.44 2.7 5.2 0 2.2-1.8 4.05-4 4.05s-4-1.84-4-4.05c0-1.76.9-3.5 2.7-5.2"/><path d="M16.7 13.5c1.8 1.7 2.7 3.44 2.7 5.2 0 2.2-1.8 4.05-4 4.05s-4-1.84-4-4.05c0-1.76.9-3.5 2.7-5.2"/>',
  ...
  sparkles: '<path d="M9.937 15.5A2 2 0 0 0 8.5 14.063l-6.135-1.58a.55.55 0 0 1 0-1.062L8.5 9.836A2 2 0 0 0 9.937 8.4l1.58-6.135a.55.55 0 0 1 1.061 0L14.063 8.4A2 2 0 0 0 15.5 9.837l6.135 1.58a.55.55 0 0 1 0 1.062L15.5 14.063a2 2 0 0 0-1.437 1.437l-1.58 6.135a.55.55 0 0 1-1.061 0z"/>',
  shield: '<path d="M20 13c0 5-3.5 7.5-7.66 8.95a1 1 0 0 1-.67-.01C7.5 20.5 4 18 4 13V6a1 1 0 0 1 1-1c2 0 4.5-1.5 5-2.5.5 1 3 2.5 5 2.5a1 1 0 0 1 1 1z"/><path d="m9 12 2 2 4-4"/>',
  trending: '<polyline points="22 7 13.5 15.5 8.5 10.5 2 17"/><polyline points="16 7 22 7 22 13"/>',
  users: '<path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87M16 3.13a4 4 0 0 1 0 7.75"/>',
  pin: '<path d="M20 10c0 6-8 12-8 12s-8-6-8-12a8 8 0 0 1 16 0Z"/><circle cx="12" cy="10" r="3"/>',
  pencil: '<path d="M21.174 6.812a1 1 0 0 0-3.986-3.987L3.842 16.174a2 2 0 0 0-.5.83l-1.322 4.352a.5.5 0 0 0 .623.622l4.353-1.32a2 2 0 0 0 .83-.5z"/>',
...
// ---------- Hero words ----------
const heroWords = ['A', 'Non-Stop', 'Fight', 'Against', 'Poverty', '&', 'Climate', 'Change'];
...
pillars.forEach((p, i) => {
  ...
  card.innerHTML = `
    ...
    <div class="pillar-card-inner">
      ...
      <div class="pillar-card-link" style="color:${p.accent};">
        Learn more
  ...
  card.addEventListener('mouseenter', () => {
    ...
    card.querySelector('.pillar-card-icon').style.backgroundColor = p.accent + '20';
    card.querySelector('.pillar-card-icon svg').setAttribute('stroke', p.accent);
    card.style.borderColor = p.accent;
  });
  card.addEventListener('mouseleave', () => {
    card.querySelector('.pillar-card-icon').style.borderColor = 'rgba(247,248,242,0.15)';
    card.querySelector('.pillar-card-icon').style.backgroundColor = 'transparent';
    card.querySelector('.pillar-card-icon svg').setAttribute('stroke', '#F7F8F2');
...
environmentInitiatives.forEach((init, i) => {
  ...
  const envImgs = [
    'https://images.pexels.com/photos/5354625/pexels-photo-5354625.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/31416070/pexels-photo-31416070.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/29290592/pexels-photo-29290592.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/37560294/pexels-photo-37560294.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/17309932/pexels-photo-17309932.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/20008982/pexels-photo-20008982.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/28662987/pexels-photo-28662987.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/38534084/pexels-photo-38534084.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
  ];
  card.innerHTML = `
...
communityAreas.forEach((area, i) => {
  ...
  card.classList.add('reveal-delay-' + Math.min(i + 1, 6));
  const communityImgs = [
    'https://images.pexels.com/photos/36666949/pexels-photo-36666949.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/36384099/pexels-photo-36384099.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/8248293/pexels-photo-8248293.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/20008982/pexels-photo-20008982.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/35697505/pexels-photo-35697505.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/38534084/pexels-photo-38534084.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
    'https://images.pexels.com/photos/36746079/pexels-photo-36746079.jpeg?auto=compress&cs=tinysrgb&h=400&w=600',
  ];
  card.innerHTML = `
...
const educationItems = ['Schools & Learning Centers', 'Scholarships & Support', 'Skills & Vocational Training', 'Adult Literacy Programs'];
...
function updateStoryBg() {
  ...
  storySteps_all().forEach((step, i) => {
    ...
    if (center < window.innerHeight * 0.7 && center > window.innerHeight * 0.2) {
      step.classList.add('visible');
    } else if (center > window.innerHeight * 0.9 || center < window.innerHeight * 0.1) {
...
function updateWasteSection() {
  ...
  const idx = Math.min(3, Math.floor(progress * 4));
  const t = (progress * 4) - idx;
  wasteSection.style.backgroundColor = lerpColor(colors[idx], colors[idx + 1] || colors[idx], t);
  ...
  wasteStepEls.forEach((step, i) => {
    ...
    if (center < window.innerHeight * 0.75 && center > window.innerHeight * 0.15) {
      step.classList.add('visible');
    } else {
      step.classList.remove('visible');
    }
...
function updateForestry() {
  ...
  forestrySection.style.backgroundColor = lerpColor(colors[idx], colors[idx + 1] || colors[idx], t);
...
const revealObserver = new IntersectionObserver((entries) => {
  entries.forEach(entry => {
    if (entry.isIntersecting) {
      ...
      counts.forEach(c => { if (!c.dataset.done) { c.dataset.done = '1'; countUp(c); } });
      revealObserver.unobserve(entry.target);
    }
  });
}, { threshold: 0.15 });

document.querySelectorAll('.reveal, .reveal-scale, .reveal-left, .reveal-right, .impact-card, .pillar-card, .community-card, .forestry-stat, .education-item').forEach(el => {
...
const orbColors = ['rgba(22,167,101,0.15)', 'rgba(0,143,156,0.15)', 'rgba(61,188,126,0.1)', 'rgba(85,199,221,0.1)'];
for (let i = 0; i < 4; i++) {
...
// ============================================
// SCROLL HANDLERS — must be after all declarations
// ============================================
